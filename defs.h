...
struct stat;
struct superblock;
struct uproc; //struct to get process info
struct thread_spinlock; //struct for spinlocks
struct thread_mutex; //struct for mutexs
...
void            wakeup(void*);
void            yield(void);
int		getprocinfo(int,struct uproc*); //function to get process info
int		thread_create(void(*)(void*),void*,void*); //function to create thread
int 		thread_join(void); //function to wait for completion of other threads
int 		thread_exit(void); //function to exit a thread
...
void            syscall(void);
int 		backtrace(void); //function to display backtrace of a program on console
